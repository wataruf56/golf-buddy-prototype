...
const FAQ = [
  ...
  {
    q: 'ゴル友はどうやって作るのですか？',
    a: '練習場やスクールで知り合う、職場の人に誘ってもらう、一人参加OKのラウンド募集に申し込む、の3つが現実的です。なかでも募集への参加は「一緒に回る」ところから始まるため、知り合ってから誘うという手間がかかりません。1回で気が合わなくても問題はなく、何度か回るうちに次も声がかかる相手が残ります。',
  },
  {
    ...
    <ArticleShell current="/guide/golf-matching" page="guide">
      ...
      <div className="toc">
        ...
        <ol>
          ...
          <li><a href="#golfriend">「ゴル友」とはどういう関係か</a></li>
      ...
      <h2 id="golfriend">「ゴル友」とは、どういう関係か</h2>
      <p>
        一緒にラウンドを回る相手のことを<strong>「ゴル友」</strong>と呼びます。
        ゴルフ友達を縮めた言い方で、募集の文面やSNSでも普通に使われます。
        いわゆる友達と違うのは、<strong>関係がラウンド単位で成立する</strong>ところです。
      </p>
      <p>
        連絡を取るのはラウンドの前後だけ、会うのは年に数回、
        プライベートには踏み込まない。それでも<strong>ゴル友としては十分に成り立ちます。</strong>
        ゴルフは同じ組で5〜6時間を一緒に過ごすので、1回回れば相手の人となりはひととおり分かる。
        だから「まず仲良くなってから誘う」という順番を踏まなくていい、というのがこの関係の特徴です。
      </p>
      <p>
        探すときに気をつけたいのは、<strong>1回で決めようとしないこと</strong>です。
        初対面の組は誰でも様子見になります。同じ人と2回目に当たったときに
        「また行きませんか」と声がかかる、という順番で残っていきます。
        1回きりで終わった相手がいても失敗ではありません。
        <strong>合う人と当たるまで回数を打てる場かどうか</strong>——
        つまり募集がどれくらいの頻度で立っているかは、サービスを選ぶときに見ておく価値があります。
      </p>
