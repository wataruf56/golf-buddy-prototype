...
export const metadata: Metadata = {
  ...
  description:
    '一緒に回るゴルフ友達が見つかる。誘える人がいなくても、一人で参加して気の合う「ゴル友」を作れます。ゴルフ初心者・ラウンドデビューでも大丈夫。「初心者歓迎」の募集だけを絞り込めて、スコア帯は「ラウンド未経験」から選べます。20〜30代限定・ラウンド後の相互レビューで安心。LINEで完結、アプリのダウンロード不要。',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '誘える人がいなくても大丈夫。一人で参加して、気の合う「ゴル友」を作れます。ゴルフ初心者・ラウンドデビューでも。20〜30代限定。',
    locale: 'ja_JP',
      ...
      <div className="wrap">
        ...
        <div className="chap">
          ...
          <div>
            ...
            <div className="tt">初心者・ラウンドデビューでも</div>
          </div>
        </div>
        <p className="lead">「下手だと迷惑かも」「初めてで不安」を、仕組みで解決します。</p>
        <div className="card">
          <h3>🔰 「初心者歓迎」の募集だけを探せる</h3>
          <p>募集する人は「初心者歓迎」を付けられて、探す人はそれだけに絞り込めます。<b>受け入れる気のある人の募集にだけ申し込める</b>ので、ラウンドデビューでも気まずくなりません。</p>
        </div>
        <div className="card">
          <h3>📝 「ラウンド未経験」とプロフィールに書ける</h3>
          <p>スコア帯は<b>「ラウンド未経験」「ラウンド数回」</b>から選べます。最初から相手に伝わるので、当日になって「実は初めてで…」と切り出す必要がありません。</p>
        </div>
        <div className="card">
          <h3>👩 女性も参加しやすい設計</h3>
