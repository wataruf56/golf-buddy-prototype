...
const ARTICLES = [
  ...
  {
    href: '/guide/golf-tokyo',
    title: '東京の20代・30代がゴルフ仲間を見つけるには',
    lead: '練習場は多いのにコースが無い東京から、どこへどう行くか。車なしの行き方も。',
    tag: '東京',
  },
  {
    href: '/guide/golf-kanagawa',
    title: '神奈川の20代・30代がゴルフ仲間を見つけるには',
    lead: '県内の西湘・箱根方面にコースがある神奈川ならではの回り方。',
    tag: '神奈川',
  },
  {
    href: '/guide/golf-chiba',
    title: '千葉の20代・30代がゴルフ仲間を見つけるには',
    lead: 'コースが近く、移動の負担がいちばん軽い地域。残る問題は「誰と行くか」だけ。',
    tag: '千葉',
  },
  {
