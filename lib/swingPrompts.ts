...
function selfBase(): string {
  return [
    ...
    '',
    '【評価ルール】',
    '以下の7フェーズ＋全体テンポ感のそれぞれについて、具体的な評価を書く。',
    ...
    '',
    'テンポ感（スイング全体のリズム）：',
    '→ 良い点：(2〜3行。トップで一瞬の溜めがある／全体が一定のテンポで進んでいる、など具体的に)',
    '→ 直した方がいい点：(2〜3行。バックスイングが速すぎる／切り返しが急、など具体的に。直すコツも添える)',
    '',
    '━━━━━━━━━━━━━━',
    '',
    '🌟 良い点（最大3つ）',
...
function compareBase(): string {
  return [
    ...
    '',
    '【評価ルール】',
    '以下の7フェーズ＋全体テンポ感のそれぞれについて、プロとの違いを具体的に文章で評価する。',
    '点数・スコア・数値評価は一切つけない。文章で評価する。',
    '',
    ...
    '',
    'テンポ感（スイング全体のリズム）：',
    '→ プロはこうしている：（2〜3行。トップでの溜めの有無、全体テンポの一定さ、切り返しの間など）',
    '→ あなたはこうなっている：（2〜3行。プロと比べてどう違うか具体的に。プロに寄せるコツも添える）',
    '',
    '━━━━━━━━━━━━━━',
    '',
    '🔍 プロとの最大の差',
...
function pastBase(): string {
  return [
    ...
    '',
    '【評価ルール】',
    '以下の7フェーズ＋全体テンポ感のそれぞれについて、過去と今回の変化を具体的に文章で評価する。',
    '点数・スコア・数値評価は一切つけない。文章で評価する。',
    '',
    ...
    '→ 今回はこうなっている：（同上）',
    '',
    'テンポ感（スイング全体のリズム）：【改善/悪化/変化なし】',
    '→ 前回はこうだった：（2〜3行。バックスイング速度・トップでの溜め・切り返しの間など）',
    '→ 今回はこうなっている：（2〜3行。前回と比べて具体的にどう変わったか）',
    '',
    '━━━━━━━━━━━━━━',
    '',
    '🌟 改善できた点（最大3つ）',
